...
void __fastcall TformMain::miSaveClick(TObject *Sender)
{
	...
	try
	{
		memoLog->Lines->SaveToFile(strLogFileNamePath + stPId->Caption + "_" + strLogFileName);
		MessageDlg(stPId->Caption + "_" + strLogFileName + " saved", mtInformation, TMsgDlgButtons() << mbOK, 0);
	}
	catch(Exception& e)
	{
